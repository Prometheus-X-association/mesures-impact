 ...
 * prepare front
 */
export async function prepareAnalyticsComponent(indexProduct, index) {
    ...
    if (chart.display === true) {
        const ctxChart = document.getElementById(chart.dom_id);
 ...
 * get data from URL
 */
async function getAnalyticsData(indexProduct, index) {
    try {
 ...
 */
async function updateAnalyticsComponent(indexProduct, index, data) {
    const config = await getConfig();
 ...
 */
function updateAnalyticsComponentText(result, data) {
 ...
 */
function updateAnalyticsComponentChart(result, data, index) {
 ...
 */
function displayComponentChart(index, ctxChart, type, labels, datasets) {
 ...
 */
function updateAnalyticsComponentTable(result, data, index) {
